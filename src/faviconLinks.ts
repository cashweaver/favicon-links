...
function setDataUrlForFavicon(
  ...
  const inner = (providerIndex: number) => {
    ...
    testDataUrl(
      ...
      (dataUrl) => !FaviconProviderDefaults[provider].includes(dataUrl),
      (dataUrl) => {
